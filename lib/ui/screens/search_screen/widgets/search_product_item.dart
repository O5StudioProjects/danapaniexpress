...
class SearchProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _buildUI(cart, auth, nav);

  }

  Widget _buildUI(cart, auth, nav){
    return Obx(
          ()=> Container(
        width: size.width,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                /// ADD TO CART BUTTON
                _addToCartButton(cart,auth, nav)
              ],
            )
  ...
  Widget _addToCartButton(cart,auth, nav){
    return Obx((){
