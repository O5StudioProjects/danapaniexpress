...
class TermsConditionsMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      ()=> _buildUI(terms, nav, isStart),
    );
  }

  Widget _buildUI(terms, nav, isStart){
    return Container(
      width: size.width,
      height: size.height,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _acceptTermsOfServices(isStart, terms, nav)
  ...
  Widget _acceptTermsOfServices(isStart, terms, nav){
    if(isStart){
      return Column(
        children: [
          _iHaveAcceptedTermsConditions(terms),
          _acceptAndDeclineButtons(isStart, terms, nav),
        ],
      );
    } else {
  ...
  Widget _iHaveAcceptedTermsConditions(terms){
    return Padding(
  ...
  Widget _acceptAndDeclineButtons(isStart, terms, nav){
    return Padding(
      padding: const EdgeInsets.only(bottom: MAIN_VERTICAL_PADDING),
      child: Row(
        children: [
