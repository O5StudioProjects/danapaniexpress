          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  appText(
                    text: 'Rs. ${calculateTotalAmount(
                      productPrice: data.productSellingPrice!,
                      quantity: productDetail.quantity.value,
                    ).toStringAsFixed(1)}/-',
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Padding(
              ...
              child: Center(
                child: appText(text: productDetail.quantity.string,
          ...
          Padding(
            ...
            child: counterButton(icon: icPlus,
                ...
                isLimitExceed: data.productQuantityLimit ==
                    productDetail.quantity.value ? true : false,
                onTap: () =>
                    productDetail.onTapPlus(productLimit: data.productQuantityLimit!)),
          ),
