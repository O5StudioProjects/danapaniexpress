...
class ProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return _buildUI(imageHeight, nameHeight, priceRowHeight, cart, auth, nav);
      },
    );
  }

  Widget _buildUI(imageHeight, nameHeight, priceRowHeight, cart, auth, nav){
    return Container(
      ...
      child: Stack(
        children: [
          Column(
            ...
            children: [
              /// 🔹 Image
              _imageSection(imageHeight),

              /// 🔹 Description
              _description(nameHeight,priceRowHeight),

              /// ADD TO CART BUTTON
              _addToCartButton(nameHeight, cart, auth, nav)
            ],
          ),
  ...
  Widget _imageSection(imageHeight){
    return Stack(
      children: [
        Container(
          width: size.width,
  ...
  Widget _description(nameHeight,priceRowHeight){
    return Padding(
        ...
        children: [
          SizedBox(
            ...
            child: Align(
              ...
              child: appText(
                text: productNameMultiLangText(data),
                maxLines: 2,
